...
import static hk.config.AppConfig.max_activity_count;
import static hk.config.AppConfig.max_display_count;
import static hk.config.AppConfig.max_sku_id;
import static hk.config.AppConfig.min_display_count;
import java.util.ArrayList;
import java.util.List;
import hk.enums.DisplayType;
